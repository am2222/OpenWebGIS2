...
var mLayers=MapCentia.gc2.map.layers;
...
if(document.getElementById("attribClustSel2").value=='0'){alert("select all options");return;}
        ...
        MapCentia.gc2.map.removeLayer(layEdCl);
        // rebuild layer
...
fillOpacity:1, strokeOpacity:1 }); 
 ...
 vectorlayer.styleMap=new OpenLayers.StyleMap({'default':new_style_layer,'select': selStyle});
        MapCentia.gc2.map.addLayer( vectorlayer );        vectorlayer.addFeatures(featuresClust);
...
highlightCtrl = new OpenLayers.Control.SelectFeature(vectorlayer, {
 ...
 renderIntent: vectorlayer.styleMapCentia.gc2.map.styles.selectStyles,
 ...
 MapCentia.gc2.map.addControl(highlightCtrl); MapCentia.gc2.map.addControl(selectCtrl);
